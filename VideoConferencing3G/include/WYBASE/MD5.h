...
//---------------------------------------------------------------------------------------
// KMD5 ¿‡∂®“Â
class AFX_EXT_CLASS KMD5
{
public:
	static std::string GetFileMD5(const std::string& filefullpath);
	static std::string GetBufferMD5(unsigned char* pBuf,unsigned int nLength);
	static std::string GetStringMD5(const std::string& buf);
