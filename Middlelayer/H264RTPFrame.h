...
public:
    ...
    void Close(void);
    void SendFrame(const unsigned char*pFrameData,int nFrameLen,int nWidth,int nHeight,int nKeyFrame,unsigned long ulTimestamp, int last);
    void SendFrameHeader(unsigned char*pRTPPacket,int nPacketLen);
    void DoSendFrame(const unsigned char*pFrameData,int nFrameLen,int nWidth,int nHeight,int nKeyFrame,unsigned long ulTimestamp, int last);
...
protected:
    void FlushRTPPackets(void);
    int CalculateFrameSize(void);
    void set_rtp_header(unsigned char*pHeader,bool bMarker);
